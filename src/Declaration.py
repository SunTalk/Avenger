...
#const.GAME_PAUSE_LEFT_BUTTON_X
#const.GAME_PAUSE_LEFT_BUTTON_Y
#const.GAME_PAUSE_LEFT_BUTTON_WIDTH
#const.GAME_PAUSE_LEFT_BUTTON_HEIGHT
#const.GAME_PAUSE_LEFT_BUTTON_FONT
#const.GAME_PAUSE_LEFT_BUTTON_SIZE
